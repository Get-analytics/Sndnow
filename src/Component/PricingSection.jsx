          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <Button
                ...
                className={`w-full rounded-full ${plan.ctaVariant === "default" ? "bg-[#7C5832] hover:bg-[#7C5832]/90 text-white" : "border-[#7C5832] text-[#7C5832] hover:bg-[#7C5832] hover:text-white"}`}
              >
                {plan.cta}
              </Button>
            </motion.div>
